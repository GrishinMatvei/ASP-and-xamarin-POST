...
namespace App1.UserService
{
    public class UsersService
    {
        ...
        { 
            ...
            Uri uri = new Uri("http://192.168.27.111:3000/users/createuser");
        ...
        public async Task<JsonTextWriter> GetAll()
        {
            Uri uri = new Uri("http://192.168.27.111:3000/users/createuser");
            ...
            HttpContent httpContent = new StringContent(JsonConvert.DeserializeObject(response), Encoding.UTF8);
            httpContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
